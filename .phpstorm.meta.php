...
'filesystems.disks.s3.report','filesystems.links./Users/gicziattila/Documents/Projects/tudera/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'auth.store','auth.destroy','auth.check_email','user.store','setup.workspace.create',
'setup.workspace.store','workspaces.index','workspaces.create','workspaces.store','workspaces.show',
...
'table.rows.index','table.rows.create','table.rows.store','table.rows.update','table.rows.destroy',
