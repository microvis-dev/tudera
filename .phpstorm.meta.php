...
'debugbar.queries.explain','sanctum.csrf-cookie','index','auth.index',
'auth.create','auth.store','auth.destroy','auth.check_email','user.store',
'user.update','user.destroy','setup.workspace.create','setup.workspace.store','signup.create',
'workspaces.get','workspaces.change','workspaces.settings','workspace.table.index','workspace.table.create',
'workspace.table.store','table.show','table.edit','table.update','table.destroy',
'table.columns.index','table.columns.create','table.columns.store','table.columns.update','table.columns.destroy',
'table.values.create','table.values.store','table.values.update','table.values.destroy','calendar.index',
'calendar.create','calendar.store','calendar.update','calendar.destroy','dashboard.index',
'todolist.store','todolist.show','todolist.update','todolist.destroy','settings.index',
'storage.local',);
...
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','AWS_ENDPOINT',
'VITE_APP_NAME',);
