...
'debugbar.queries.explain','index','auth','auth.check_email',
'auth.store','logout','setup.user.create','user.store','setup.workspace.create',
'setup.workspace.store','workspaces','workspace.delete','workspace.update','workspace.create',
'workspace.store','storage.local',);
