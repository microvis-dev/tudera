...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/preilakos/proj/mv-tudera/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.request_checksum_calculation','filesystems.disks.s3.response_checksum_validation','filesystems.links./Users/preilakos/proj/mv-tudera/public/storage','logging.default',
...
'inertia.testing.page_extensions','inertia.history.encrypt','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'debugbar.queries.explain','index','auth.index','auth.create',
'auth.store','auth.destroy','auth.check_email','user.store','user.update',
'user.destroy','setup.workspace.create','setup.workspace.store','signup.create','workspaces.index',
'workspaces.create','workspaces.store','workspaces.show','workspaces.edit','workspaces.update',
'workspaces.destroy','workspace.table.index','workspace.table.create','workspace.table.store','table.show',
'table.edit','table.update','table.destroy','table.columns.index','table.columns.create',
'table.columns.store','table.columns.update','table.columns.destroy','table.values.create','table.values.store',
...
'todolist.update','todolist.destroy','settings.index','storage.local',);
