...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.s3.request_checksum_calculation' => 'string',
            'filesystems.disks.s3.response_checksum_validation' => 'string',
            'filesystems.links./Users/david/Documents/GitHub/tudera/public/storage' => 'string',
...
'datatables.json.options','datatables.callback','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.request_checksum_calculation','filesystems.disks.s3.response_checksum_validation',
'filesystems.links./Users/david/Documents/GitHub/tudera/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'debugbar.queries.explain','sanctum.csrf-cookie','workspace.invite.create',
'index','auth.index','auth.create','auth.store','auth.destroy',
'auth.check_email','user.store','user.update','user.destroy','setup.workspace.create',
'setup.workspace.store','signup.create','workspaces.get','workspaces.change','workspaces.settings',
'workspaces.user.create','workspaces.user.store','workspaces.user.show','workspaces.user.update','workspaces.user.destroy',
'workspace.table.index','workspace.table.create','workspace.table.store','table.show','table.edit',
'table.update','table.destroy','table.columns.index','table.columns.create','table.columns.store',
'table.columns.update','table.columns.destroy','table.values.store','table.values.update','table.values.destroy',
'calendar.index','calendar.create','calendar.store','calendar.update','calendar.destroy',
'dashboard.index','todolist.store','todolist.show','todolist.update','todolist.destroy',
'settings.index','selectvalues.store','selectvalues.update','selectvalues.destroy','notification.store',
'notification.destroy','storage.local',);
...
'VITE_PORT','ADMINER_PORT','LARAVEL_PORT','APP_NAME','APP_ENV',
'APP_KEY','DEBUGBAR_ENABLED','APP_TIMEZONE','APP_URL','APP_LOCALE',
...
'DB_ROOT_PASSWORD','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
